  ...
  return (
    <AdminLayout>
      ...
      <Seo
        ...
        description="Manage your account settings on easyinventory. Update your name, email, and password for a secure experience."
        keywords="account settings, user profile, change password, update profile, easyinventory"
        url="https://easyinventory.online/settings"
      />
