...
const Billing = () => {
  ...
  if (quantity > 0 && quantity <= product.quantity) {
    ...
    // Clear the temporary price after adding to order
  ...
  try {
    ...
    // Upload the PDF to a temporary file hosting service
    ...
    // Get the direct download link (tmpfiles.org specific)
...
<div className="bg-white p-6 rounded-lg shadow mb-6">
  <div className="grid grid-cols-1 md:grid-cols-12 gap-4">
    {/* Product Dropdown - Takes full width on mobile, 5 columns on desktop */}
    ...
    {/* Quantity Input - 3 columns on desktop */}
    ...
    {/* Price Edit Section - 2 columns on desktop */}
    {selectedProductId && (
  ...
  {/* Reset Price Button (shown only when in edit mode) */}
  {editPriceMode && (
