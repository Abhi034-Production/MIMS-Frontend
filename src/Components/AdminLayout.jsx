    ...
    return (
        <>
            <div className="flex min-h-screen h-screen overflow-hidden">
                {/* Sidebar */}
                <aside
                    className={`bg-gray-600 p-5 text-white fixed md:relative h-screen 
                ...
                <main className="flex-1 flex flex-col min-h-0 overflow-hidden">
                    {/* Top Bar */}
                    <div className="border-b w-full h-16 flex items-center px-4 bg-white shadow-sm flex-shrink-0">
                        {/* Mobile Nav Toggle */}
                        <button
