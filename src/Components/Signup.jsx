...
const Signup = () => {
  ...
  return (
    <>
      <Seo
        title="Signup | easyinventory"
        description="Create your account on easyinventory. Signup to access exclusive features and manage your inventory."
        keywords="signup, register, create account, inventory management, easyinventory"
        url="https://easyinventory.online/signup"
      />
